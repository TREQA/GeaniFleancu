...
public class InterestRates_Print extends TestBase {
    ...
    public void interestRates_1_lastValue_Print(String interestRateNR, String interestRateName) {
        ...
        Log4Test.info(NEW_LINE +
                "Interest Rate Name " + interestRateName + NEW_LINE +
                "Period: " + interestRatesListResponse.path(interestRateNR + ".rates[0].period.value") + " " + interestRatesListResponse.path(interestRateNR + ".rates[0].period.unit") + NEW_LINE +
                " last value: " + interestRatesListResponse.path(interestRateNR + ".rates[0].value.value") + NEW_LINE +
                "Period: " + interestRatesListResponse.path(interestRateNR + ".rates[1].period.value") + " " + interestRatesListResponse.path(interestRateNR + ".rates[1].period.unit") + NEW_LINE +
                " last value: " + interestRatesListResponse.path(interestRateNR + ".rates[1].value.value") + NEW_LINE +
                "Period: " + interestRatesListResponse.path(interestRateNR + ".rates[2].period.value") + " " + interestRatesListResponse.path(interestRateNR + ".rates[2].period.unit") + NEW_LINE +
                " last value: " + interestRatesListResponse.path(interestRateNR + ".rates[2].value.value") + NEW_LINE +
                "Period: " + interestRatesListResponse.path(interestRateNR + ".rates[3].period.value") + " " + interestRatesListResponse.path(interestRateNR + ".rates[3].period.unit") + NEW_LINE +
                " last value: " + interestRatesListResponse.path(interestRateNR + ".rates[3].value.value") + NEW_LINE);
    }
